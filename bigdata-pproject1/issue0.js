...
var helper = {
    randonIntNext : (min, max) =>{
        return Math.floor( Math.random( )  * (max - min + 1 )  ) + min;
    },
    arrayTakeRandomMember: (arrray) =>{
        return arrray[helper.randonIntNext( 0  , arrray.length - 1 )];
    },
    arrayTakeRandomMemberMongo: (arrray , length) =>{
        return arrray[helper.randonIntNext( 0  , length - 1 )];
    }
}
var validator = 
{    
...
var dbw =
{
    ...
    updateEmployee: ( emp ) =>{
        ...
        db.Employees.updade({ _id:employee._id }, emp );
    },
    deleteEmployee: ( id ) =>{
    ...
    updateClient: ( client ) =>{
        ...
        db.Clients.updade({ _id:cli._id }, client );
    },
    deleteClient: ( id ) =>{
    ...
    updateDepartment: ( dep ) =>{
        ...
        db.Departments.updade({ _id: department._id }, dep );
    },
    deleteDepartment: ( id ) =>{
...
var initializer = {
    ...
    generateEmployees:(quantity)=>
    {
        ...
        while (quantity > 0) {
            ...
            let employee  =
            {
                ...
                "phoneNumber" : "+35989" + helper.randonIntNext(100000,999999)  , 
            ...
            //defining bosses
            if(helper.randonIntNext(1,100) <= 60 )
            {
                bosses.push(employee);
            }
            //random push the employee to boss
            if(bosses.length > 0 && helper.randonIntNext(1,100) <=60 )
            {
    ...
    generateClients:(quantity) =>
    {
        ...
        while(quantity > 0)
        {
            ...
            accQuantity =  helper.randonIntNext(1,5);
            for (let index = 0; index < accQuantity; index++) {
                ...
                let acc =
                {
                    ...
                    "amount" : helper.randonIntNext(1000,10000),
                    "idClient" : client._id
                }
